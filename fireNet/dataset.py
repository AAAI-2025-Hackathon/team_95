...
class NextDayFireDataset(torch.utils.data.Dataset):
    ...
    def __len__(self):
        if self.max_samples is not None:
            if self.tf_dataset.reduce(0, lambda x, _: x + 1).numpy()>self.max_samples:
...
if __name__ == '__main__':
    ...
    file_pattern = '/s/lovelace/h/nobackup/sangmi/hackathon/AAAI-2025/data/Next_Day_Wildfire_Spread/2/next_day_wildfire_spread_eval_*.tfrecord'
