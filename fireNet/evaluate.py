...
import torch
from train import result_analysis
...
test_data_file_pattern = '/s/lovelace/h/nobackup/sangmi/hackathon/AAAI-2025/data/northamerica_2012-2023/test/_ongoing_*.tfrecord'
...
checkpoint_path = './checkpoints/ResNetUNet_checkpoint_epoch10.pth'  # Replace with the correct path
...
result_analysis(
    ...
    save_dir='results',
    epoch=10,  # Replace with the epoch number you want to analyze
)